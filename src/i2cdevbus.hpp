...
public:
    ...
    static const uint16_t DEFAULT_READ_TIMEOUT_MS = 500;
    ...
    [[nodiscard]] virtual auto readReg8(
        i2cdev_dev_addr_t devAddr,
        i2cdev_reg_addr_t regAddr,
        size_t length,
        uint8_t *data,
        uint16_t timeout
    ) -> i2cdev_result_t = 0;
    ...
    [[nodiscard]] auto readReg8(
        ...
        i2cdev_reg_addr_t regAddr,
        U &data,
        uint16_t timeout = I2CDevBus::DEFAULT_READ_TIMEOUT_MS
    ) -> i2cdev_result_t;
    ...
    template<typename U>
    [[nodiscard]] auto
    writeReg8(i2cdev_dev_addr_t devAddr, i2cdev_reg_addr_t regAddr, const U &data) -> i2cdev_result_t;
    ...
    [[nodiscard]] inline auto writeReg8(
        i2cdev_dev_addr_t devAddr, i2cdev_reg_addr_t regAddr, uint8_t data
    ) -> i2cdev_result_t;
    ...
    [[nodiscard]] inline auto updateReg8Bit(
        i2cdev_dev_addr_t devAddr, i2cdev_reg_addr_t regAddr, uint8_t bit, bool value
    ) -> i2cdev_result_t;
    ...
    template<typename U>
    [[nodiscard]] auto
    writeReg16(i2cdev_dev_addr_t devAddr, i2cdev_reg_addr_t regAddr, const U &data) -> i2cdev_result_t;
    ...
    [[nodiscard]] inline auto writeReg16(
        i2cdev_dev_addr_t devAddr, i2cdev_reg_addr_t regAddr, uint16_t data
    ) -> i2cdev_result_t;
...
[[nodiscard]] inline auto I2CDevBus::updateReg8(
    const i2cdev_dev_addr_t devAddr,
    const i2cdev_reg_addr_t regAddr,
    const uint8_t mask,
    const uint8_t value
...
[[nodiscard]] inline auto I2CDevBus::updateReg16(
    const i2cdev_dev_addr_t devAddr,
    const i2cdev_reg_addr_t regAddr,
    const uint16_t mask,
